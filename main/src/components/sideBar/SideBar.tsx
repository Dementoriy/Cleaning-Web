    ...
    return (
      <div style={{backgroundColor: '#B1A18B', marginTop: '-7px', height: '58%', padding: '10px', width: '13%', minWidth: '220px', paddingBottom: '50px'}}>
          <Stack direction="row" alignItems="stretch">
            ...
            <Typography sx={{fontSize: '30px', color: 'white'}}>Чистый дом</Typography>
          </Stack>
          {user.client.isAuth && (
          <>
            ...
            <Button variant="contained" color="secondary" disableElevation sx={{ width: '100%', borderRadius: '10px', mt: '60%'}} startIcon={<ExitToAppIcon />} onClick={() => {dispatch(AuthService.logout()), navigate("/")}}>
              Выйти
            </Button>
          </>
          )}
