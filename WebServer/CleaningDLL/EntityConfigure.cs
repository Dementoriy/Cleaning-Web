...
namespace CleaningDLL
{
    public static class EntityConfigure
    {
        ...
        {
            builder.HasData(new Service("Экспресс уборка", "Сухая, влажная уборка полов, плинтусов. Протирка пыли на доступных поверхностях. Чистка и дезинфекция сантехники. Протирка фасадов кухонного гарнитура. Чисткка стеновой панели фартука. Мытьё кухонной плиты снаружи. Удаление пыли с кухонной техники. Мытьё посуды \"Одна заполненная раковина\" Проветривание помещения Вынос мусора.", 40, 1, 100, null, true) { ID = 1, UnitsID = 1 });
            builder.HasData(new Service("Генеральная уборка", "C помощью пылесоса и парогенератора удаляется пыль. Устраняется грязь с поверхности кроватей, диванов, кресел, мебели, электроники, люстр, стеклянных перегородок и зеркал, штор. Дезинфекция сантехники: унитазов, ванн, душевых кабин, раковин.Устранение следов жира, обработка кухонной техники снаружи и внутри. Мойка кафельной плитки и очистка швов в ванной комнате.", 70, 1, 220, null, true) { ID = 2, UnitsID = 1 });
            builder.HasData(new Service("Послестроительная уборка", "Расширенная генеральная уборка, включающая в себя: устранение остатков лакокрасочных составов, извести, скотча. Мытье стеклянных и зеркальных поверхностей без разводов. Тщательная очистка напольных покрытий. Обеззараживание сантехники. Сбор и вывоз строительного мусора.", 80, 1, 220, null, true) { ID = 3, UnitsID = 1 });
            builder.HasData(new Service("Комплексная уборка", "Мойка полов, плинтусов, стекляных и зеркальных поверхностей. Удаление загрязнений с подоконников. Удаление пыли с оргтехники и горизонтальных поверхностей. Полив цветов. Вынос мусора. Пылесосим ковры. Раскладываем вещи на места. Застилаем кровать и меняем постельное.", 50, 1, 100, null, true) { ID = 4, UnitsID = 1 });
